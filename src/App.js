...
>>>>>>> fea4d5119c52022fab477fa5c5c93a1ad7bc7a7a
            </div>
...
function ContactPage({ navigateTo }) {
  ...
  return (
    <>
      <section
        style={{ ...styles.contact, paddingTop: "160px" }}
        className="page-enter"
      >
        <div style={styles.sectionContainer}>
          <button
          ...
          <div
            style={{ ...styles.contactWrapper, animationDelay: "0.2s" }}
            className="animate-fade-up"
          >
            <div style={styles.contactInfo}>
              <h2
                style={{ ...styles.contentTitle, marginTop: 0 }}
              ...
              {[
                ...
                >
                  ...
                  <p style={{ ...styles.contentText, margin: 0 }}>
                    {item.content}
                  </p>
                </div>
              ))}
            ...
            >
              ...
              <div
                style={{ ...styles.formGroup, animationDelay: "0.1s" }}
                className="animate-fade-up"
              >
              ...
              <div
                style={{ ...styles.formGroup, animationDelay: "0.2s" }}
                className="animate-fade-up"
              >
              ...
              <div
                style={{ ...styles.formGroup, animationDelay: "0.3s" }}
                className="animate-fade-up"
              >
...
const styles = {
  ...
  hero: {
    ...
    minHeight: "100vh",
    background:
      "linear-gradient(135deg, #0a0e27 0%, #1a1f3a 50%, #0f132e 100%)",
  ...
  imagePlaceholderHero: {
    ...
    aspectRatio: "1",
    background:
      "linear-gradient(135deg, rgba(212, 175, 55, 0.15) 0%, rgba(167, 46, 46, 0.08) 100%)",
  ...
  concepts: {
    background:
      "linear-gradient(to bottom, #0a0e27 0%, #1a1f3a 50%, #0a0e27 100%)",
    padding: "8rem 5%",
    position: "relative",
  },
  ...
  vietnamImage: {
    aspectRatio: "4/5",
    background:
      "linear-gradient(135deg, rgba(212, 175, 55, 0.15) 0%, rgba(167, 46, 46, 0.1) 100%)",
  ...
  benefitsLargeImage: {
    ...
    aspectRatio: "16/9",
    background:
      "linear-gradient(135deg, rgba(212, 175, 55, 0.12) 0%, rgba(167, 46, 46, 0.08) 100%)",
